...
export const deactivateStaffHandler = asyncHandler(async (req, res) => {
  const result = await deactivateStaff(req.params.id, req.user.societyId);
  ...
  return successResponse(
    res,
    200,
    "Staff member deactivated successfully. Account login has been revoked."
  );
});
